...
trait MoveMakingIteratorWithVariationsBehaviors[T, U] extends should.Matchers with Inside
{
  this: AnyFlatSpec =>

  def createIterator(game: Game): MoveMakingIteratorWithVariations[T, U]

  def createElementOption(board: Board): Option[T]

  def createElement(board: Board, move: Move, nextBoard: Board): T

  def moveMakingIteratorWithVariations
  {
    ...
    it should "iterate by the elements for the game with one variation" in {
      ...
      elems(i + 5) should be (createElement(
          Board("rnbqkb1r/pppp1ppp/5n2/4p3/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 2 3"),
          NormalMove(Piece.Knight, G1, F3, None, false),
          Board("rnbqkb1r/pppp1ppp/5n2/4p3/4P3/2N2N2/PPPP1PPP/R1BQKB1R b KQkq - 3 3")))
    }
    ...
    it should "iterate by the elements for the game with two variations" in {
      ...
      inside(createElementOption(Board.Initial)) {
        case Some(expectedElem) =>
          elems should have length (9)
          elems(0) should be (expectedElem)
          i += 1
        case None =>
          elems should have length (8)
      }
      elems(i + 0) should be (createElement(
          Board.Initial,
          NormalMove(Piece.Pawn, E2, E4, None, false),
      ...
      elems(i + 3) should be (createElement(
          Board("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2"),
          NormalMove(Piece.Bishop, F1, C4, None, false),
          Board("rnbqkbnr/pppp1ppp/8/4p3/2B1P3/8/PPPP1PPP/RNBQK1NR b KQkq - 1 2")))
      elems(i + 4) should be (createElement(
          Board("rnbqkbnr/pppp1ppp/8/4p3/2B1P3/8/PPPP1PPP/RNBQK1NR b KQkq - 1 2"),
          NormalMove(Piece.Bishop, F8, C5, None, false),
          Board("rnbqk1nr/pppp1ppp/8/2b1p3/2B1P3/8/PPPP1PPP/RNBQK1NR w KQkq - 2 3")))
      elems(i + 5) should be (createElement(
          Board("rnbqkbnr/pppp1ppp/8/4p3/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2"),
          NormalMove(Piece.Knight, G1, F3, None, false),
          Board("rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2")))
      elems(i + 6) should be (createElement(
          Board("rnbqkbnr/pppp1ppp/8/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R b KQkq - 1 2"),
          NormalMove(Piece.Knight, B8, C6, None, false),
          Board("r1bqkbnr/pppp1ppp/2n5/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 2 3")))
      elems(i + 7) should be (createElement(
          Board("rnbqkbnr/pppp1ppp/8/4p3/4P3/2N5/PPPP1PPP/R1BQKBNR b KQkq - 1 2"),
          NormalMove(Piece.Knight, G8, F6, None, false),
          Board("rnbqkb1r/pppp1ppp/5n2/4p3/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 2 3")))
    }
    ...
    it should "iterate by the elements for the game with the subvariation" in {
      ...
      elems(i + 4) should be (createElement(
          Board("r1bqkbnr/pppppppp/2n5/8/4P3/2N5/PPPP1PPP/R1BQKBNR b KQkq - 0 2"),
          NormalMove(Piece.Knight, G8, F6, None, false),
          Board("r1bqkb1r/pppppppp/2n2n2/8/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 1 3")))
      elems(i + 5) should be (createElement(
          Board("r1bqkb1r/pppppppp/2n2n2/8/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 1 3"),
          NormalMove(Piece.Bishop, F1, D3, None, false),
          Board("r1bqkb1r/pppppppp/2n2n2/8/4P3/2NB4/PPPP1PPP/R1BQK1NR b KQkq - 2 3")))
      elems(i + 6) should be (createElement(
          Board("r1bqkb1r/pppppppp/2n2n2/8/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 1 3"),
          NormalMove(Piece.Knight, G1, F3, None, false),
          Board("r1bqkb1r/pppppppp/2n2n2/8/4P3/2N2N2/PPPP1PPP/R1BQKB1R b KQkq - 2 3")))
      elems(i + 7) should be (createElement(
          Board("r1bqkb1r/pppppppp/2n2n2/8/4P3/2NB4/PPPP1PPP/R1BQK1NR b KQkq - 2 3"),
          NormalMove(Piece.Pawn, E7, E5, None, false),
          Board("r1bqkb1r/pppp1ppp/2n2n2/4p3/4P3/2NB4/PPPP1PPP/R1BQK1NR w KQkq - 0 4")))
      elems(i + 8) should be (createElement(
          Board("r1bqkbnr/pppp1ppp/2n5/4p3/4P3/2N5/PPPP1PPP/R1BQKBNR w KQkq - 0 3"),
          NormalMove(Piece.Knight, G1, F3, None, false),
  ...
  def moveMakingIteratorWithVariationsForIllegalMoves
  {
